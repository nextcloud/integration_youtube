OC.L10N.register(
    ...
    "YouTube API Key not set" : "未設定 YouTube API 密鑰",
    "Could not decrypt the YouTube API key" : "無法加密 YouTube API 密鑰",
    ...
    "Enter a YouTube Data API Key below to use the smart picker and the search." : "在下方輸入 YouTube Data API 密鑰以使用智慧型挑選程式與搜尋。",
    "Visit" : "造訪",
